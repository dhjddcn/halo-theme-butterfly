...
export function crossLine() {
  return `<div class="loading-crossLine">
  <svg xmlns="http://www.w3.org/2000/svg" height="128px" width="256px" viewBox="0 0 256 128" class="loading-crossLine-svg">
  <defs>
  ...
  <g stroke="#ddd" class="loading-crossLine__track">
  <path d="M8,64s0-56,60-56,60,112,120,112,60-56,60-56"></path>
    <path d="M248,64s0-56-60-56-60,112-120,112S8,64,8,64"></path>
    </g>
    <g stroke-dasharray="180 656">
  <path d="M8,64s0-56,60-56,60,112,120,112,60-56,60-56" stroke-dashoffset="0" stroke="url(#grad1)" class="loading-crossLine__worm1"></path>
    <path d="M248,64s0-56-60-56-60,112-120,112S8,64,8,64" stroke-dashoffset="358" stroke="url(#grad2)" class="loading-crossLine__worm2"></path>
    </g>
    </g>
    </svg>
</div>`;
