 ...
 * @param content
 */
export function useImportStyle(type, content) {
  const style = document.createElement('style');

  if(type === 'url') style.setAttribute('href', content);

  if(type === 'str') style.innerHTML = content;
 ...
 * 使用图片预览
 */
export async function useFancybox() {
