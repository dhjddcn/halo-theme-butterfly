...
export default class codeBlock {
  ...
  #codeBlock(){
    ...
    // 代码块主题切换
    MainApp.action.theme.change((mode) => this.#codeBlockTheme(mode));
  }
  ...
  #codeBlockToolbar() {
    ...
    pres.each((index, dom) => {
      ...
      if(toolbar) {
        ...
        // 自定义设置
        this.#codeBlockToolbarCustom(toolbar, pre);
      }
    });
   ...
   * @param pre
   */
  #codeBlockToolbarCustom(toolbar, pre){
