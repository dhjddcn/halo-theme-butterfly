...
<#--        <script src="${BASE_RES_URL!}/source/lib/prism/prism.min.js"></script>-->
    ...
    <#if  type == 'categories'><script src="${BASE_RES_URL!}/source/lib/echarts/echarts.min.js"></script></#if>
    ...
    <#if  type !='sheet'><script src="${BASE_RES_URL!}/source/js/min/by.${type}.min.js"></script></#if>
    <#if type == 'post' || type == 'journals'><script src="${BASE_RES_URL!}/source/lib/prism/prism.min.js"></script></#if>
</#macro>
