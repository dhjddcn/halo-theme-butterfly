    ...
    <div class="aside_widget   setup">
        ...
        <div class="set">
            <button class="theme-switch control" title="浅色和深色模式转换">
                <svg t="1658763689603" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                     p-id="1286" width="16">
                    <path d="M982.170829 312.04352C892.360909 99.81952 671.683789-26.09152 443.290829 4.57216 214.897869 35.23584 35.242189 214.89152 4.578509 443.28448c-30.66368 228.39296 95.24736 449.07008 307.47136 538.88A511.14496 511.14496 0 0 0 1022.378189 511.0784a508.17024 508.17024 0 0 0-40.20736-199.03488z m-163.99872 506.12224a431.22176 431.22176 0 0 1-288.36864 126.78656v-305.91488l1.2032-0.4096-1.2032-3.5328V77.18912c232.35584 10.0096 415.5904 201.30816 415.58016 433.88416a431.45216 431.45216 0 0 1-127.21152 307.09248z m0 0"
                          p-id="1287"></path>
                </svg>
            </button>
        </div>

        <button class="setting" title="设置">
            <svg t="1658766459778" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="9135" width="20">
        ...
        <button class="to-top" title="回到顶部">
            <svg t="1658763920187" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="1569" width="18">
                <path d="M912.72533333 477.86666666L512 76.97066666 111.27466667 477.86666666 256 622.592l153.6-153.6V977.06666666h204.8V468.992l153.6 153.6 144.72533333-144.72533334z"
                      p-id="1570"></path>
            </svg>
        </button>
...
<#macro  Footer>
    <footer class="footer">
        ...
        <div class="powered">
            ...
            Theme by&nbsp;<a class="theme" title="当前主题：${theme.name!}" href="${theme.repo!}"
                             target="_blank">${theme.author.name!}</a>
        </div>
    </footer>
</#macro>
...
<#macro AboveIndex >
    <section class="above">
        <div class="above_content">
            <h1 class="above_site--title">${blog_title!}</h1>
            <div class="above_site--desc">
                <span class="typed-text"
                      data-custom-desc="${settings.index_custom_description!user.description!}"></span>
            </div>
            <div class="above_site--social">
                <#if settings.qq??>
                    <a class="qq"
                       href="tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=${settings.qq!}&website=${context!}"
                       rel="noopener noreferrer nofollow">
                        <svg t="1646466614091" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="2126" width="28">
                ...
                <#if settings.github??>
                    <a class="github" href="${settings.github!}" rel="noopener noreferrer nofollow">
                        <svg t="1646319571226" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="11339" width="28">
                ...
                <#if settings.zhihu??>
                    <a class="zhihu" href="${settings.zhihu!}" rel="noopener noreferrer nofollow">
                        <svg t="1646319889132" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="12604" width="28">
                ...
                <#if settings.email??>
                    <a class="email" href="mailto:${settings.email!}" rel="noopener noreferrer nofollow">
                        <svg t="1646319922974" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="13585" width="28">
                ...
                <#if settings.bili??>
                    <a class="bili" href="mailto:${settings.email!}" rel="noopener noreferrer nofollow">
                        <svg t="1658760654289" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="4550" width="30">
