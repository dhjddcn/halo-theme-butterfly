                    ...
                    <a class="qq"
                       ...
                       rel="noopener noreferrer nofollow">
                        <svg t="1647012057227" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="6984" width="25" height="25">
                ...
                <#if settings.github??>
                    <a class="github" href="${settings.github!}" rel="noopener noreferrer nofollow">
                        <svg t="1647012313015" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="11603" width="25" height="25">
                ...
                <#if settings.email??>
                    <a class="email" href="mailto:${settings.email!}" rel="noopener noreferrer nofollow">
                        <svg t="1647012442993" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="13550" width="25" height="25">
