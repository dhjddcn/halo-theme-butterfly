    ...
    <aside class="by_aside">
        ...
        <div class="by_user_info by_card_widget">
            <div class="center">
                ...
                <#assign description = user.description?split(';')>
                <div class="by_user_desc">${description[0]!}</div>
            </div>
            ...
            <div class="by_user_social_icons center">
                ...
                <#if settings.email != '' >
                    <a href="mailto:${settings.email!}" target="_blank" title="邮箱${settings.email!}">
