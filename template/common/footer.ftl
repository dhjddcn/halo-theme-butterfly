    ...
    <footer class="by_footer center">
        <p>
            ...
            <#if settings.icp?? && settings.icp != ''> - <a href="https://beian.miit.gov.cn"
		 		    ...
		 		    <#if settings.police?? && settings.police != ''> - <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=${settings.police?replace('[^\\d]','','ri')}" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;">
