...
function $modal( data ) { // data 必传 且为对象
    ...
    let idText = "modailItem";
    const date = (new Date().getTime() * Math.random() + '').substr( 0, 10 );
    idText += date;

    const titleSize = 16; //标题文字大小
